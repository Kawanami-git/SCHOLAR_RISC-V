...
\details
  Centralizes register-file sizing,
...
\remarks
  - Keep these encodings in sync with fetch/decode/execute/Writeback logic.
...
|:-------:|:----------:|:---------|:--------------------------------------------|
| 1.0     | 29/03/2026 | Kawanami | Initial version of the core package.        |
********************************************************************************
*/

package core_pkg;
  /// Number of bits in a byte
  localparam int unsigned BYTE_LENGTH = 8;
  ...
  localparam int unsigned EXE_CTRL_WIDTH = 5;
  /// Add operation code
  ...
  localparam int unsigned PC_CTRL_WIDTH = 2;
  /// PC increment (+4)
  ...
  localparam int unsigned MEM_CTRL_WIDTH = 4;
  ...
  localparam int unsigned GPR_CTRL_WIDTH = 3;
  /// No update to GPR
  ...
  localparam int unsigned CSR_CTRL_WIDTH = 2;
  /// No update to CSR - not a CSR op
  localparam logic [CSR_CTRL_WIDTH-1:0] CSR_IDLE = 2'b00;
  /* verilator lint_off UNUSEDPARAM */
  /// No update to CSR - Read only
