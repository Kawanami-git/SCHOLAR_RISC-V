...
`ifdef SIM
    ...
    output wire  [                  Archi - 1 : 0] mhpmcounter5,
    /// CSR mhpmcounter6 register
    output wire  [                  Archi - 1 : 0] mhpmcounter6,
    /// CSR mhpmcounter7 register
    output wire  [                  Archi - 1 : 0] mhpmcounter7,
    /// CSR mhpmcounter8 register
    output wire  [                  Archi - 1 : 0] mhpmcounter8,
    /// CSR mhpmcounter9 register
    output wire  [                  Archi - 1 : 0] mhpmcounter9,
    /// CSR mhpmcounter10 register
    output wire  [                  Archi - 1 : 0] mhpmcounter10,
    /// CSR mhpmcounter11 register
    output wire  [                  Archi - 1 : 0] mhpmcounter11,
    /// CSR mhpmcounter12 register
    output wire  [                  Archi - 1 : 0] mhpmcounter12,
...
`ifdef SIM
      ...
      .mhpmcounter5_o    (mhpmcounter5),
      .mhpmcounter6_o    (mhpmcounter6),
      .mhpmcounter7_o    (mhpmcounter7),
      .mhpmcounter8_o    (mhpmcounter8),
      .mhpmcounter9_o    (mhpmcounter9),
      .mhpmcounter10_o   (mhpmcounter10),
      .mhpmcounter11_o   (mhpmcounter11),
      .mhpmcounter12_o   (mhpmcounter12),
      .mhpmcounter13_o   (mhpmcounter13),
