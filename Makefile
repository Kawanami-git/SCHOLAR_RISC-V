...
DUT_FILES						= $(DUT_DIR)common/core_pkg.sv \
								  ...
								  $(DUT_DIR)common/exe2id_pkg.sv\
								  $(DUT_DIR)common/mem2wb_pkg.sv\
								  $(DUT_DIR)common/mem2ctrl_pkg.sv\
								  $(DUT_DIR)common/mem2id_pkg.sv\
								  $(DUT_DIR)common/wb2ctrl_pkg.sv\
								  $(DUT_DIR)common/wb2id_pkg.sv\
								  $(DUT_DIR)common/wb2exe_pkg.sv\
								  $(DUT_DIR)common/wb2mem_pkg.sv\
								  $(DUT_DIR)common/ctrl2id_pkg.sv\
...
ISA_YAML_FILES					= $(ISA_YAML_DIR)i/u_instr/lui.yaml \
								  ...
								  $(ISA_YAML_DIR)Zicntr_instr/mhpmcounter5.yaml \
								  $(ISA_YAML_DIR)Zicntr_instr/mhpmcounter6.yaml \
								  $(ISA_YAML_DIR)Zicntr_instr/mhpmcounter7.yaml \
								  $(ISA_YAML_DIR)Zicntr_instr/mhpmcounter8.yaml \
								  $(ISA_YAML_DIR)Zicntr_instr/mhpmcounter9.yaml \
								  $(ISA_YAML_DIR)Zicntr_instr/mhpmcounter10.yaml
