...
********************************************************************************
\file       load.h
\brief      Firmware loader API for SCHOLAR RISC-V (addr:data textual format)
\author     Kawanami
\version    1.0
\date       25/10/2025

\details
  Public API to load a textual firmware file into the SCHOLAR RISC-V memories.
...
/*!
 * \brief Load a firmware text file into the SCHOLAR RISC-V INSTR/DATA memories.
 *
