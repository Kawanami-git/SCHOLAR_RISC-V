...
main(int argc, char* argv[])
{
  ...
  /*
   * SCHOLAR RISC-V
   * Reset the core-to-platform shared memory with zero.
   */
...
#error "Please define a way to initialize a memory block."
  ...
  mhpmcounter3  = read_mhpmcounter3();
  mhpmcounter4  = read_mhpmcounter4();
  mhpmcounter5  = read_mhpmcounter5();
  mhpmcounter6  = read_mhpmcounter6();
  mhpmcounter7  = read_mhpmcounter7();
  mhpmcounter8  = read_mhpmcounter8();
  mhpmcounter9  = read_mhpmcounter9();
  mhpmcounter10 = read_mhpmcounter10();
  mhpmcounter11 = read_mhpmcounter11();
  mhpmcounter12 = read_mhpmcounter12();
  mhpmcounter13 = read_mhpmcounter13();
  start_time();
#if (MULTITHREAD > 1)
   ...
   */
  mhpmcounter3  = read_mhpmcounter3() - mhpmcounter3;
  mhpmcounter4  = read_mhpmcounter4() - mhpmcounter4;
  mhpmcounter5  = read_mhpmcounter5() - mhpmcounter5;
  mhpmcounter6  = read_mhpmcounter6() - mhpmcounter6;
  mhpmcounter7  = read_mhpmcounter7() - mhpmcounter7;
  mhpmcounter8  = read_mhpmcounter8() - mhpmcounter8;
  mhpmcounter9  = read_mhpmcounter9() - mhpmcounter9;
  mhpmcounter10 = read_mhpmcounter10() - mhpmcounter10;
  mhpmcounter11 = read_mhpmcounter11() - mhpmcounter11;
  mhpmcounter12 = read_mhpmcounter12() - mhpmcounter12;
  mhpmcounter13 = read_mhpmcounter13() - mhpmcounter13;
  /**/
  ...
  ee_printf("Use of Exe       -> Decode (op1/op2) bypass           : %u\n", mhpmcounter5);
  ee_printf("Use of Exe       -> Decode (op3)     bypass           : %u\n", mhpmcounter6);
  ee_printf("Use of Mem       -> Decode (op1/op2) bypass           : %u\n", mhpmcounter7);
  ee_printf("Use of Mem       -> Decode (op3)     bypass           : %u\n", mhpmcounter8);
  ee_printf("Use of Writeback -> Decode (op1/op2) bypass           : %u\n", mhpmcounter9);
  ee_printf("Use of Writeback -> Decode (op3)     bypass           : %u\n", mhpmcounter10);
  ee_printf("Use of Writeback -> Exe    (op1/op2) bypass           : %u\n", mhpmcounter11);
  ee_printf("Use of Writeback -> Exe    (op3)     bypass           : %u\n", mhpmcounter12);
  ee_printf("Use of Writeback -> Mem    (op3)     bypass           : %u\n", mhpmcounter13);
  ee_printf("\n");
